...
const FontFace = css`
  ...
  @font-face {
    ...
    font-style: normal;
    font-weight: 100;
    src: local('Roboto Thin'), local('Roboto-Thin'), url(${ROBOTO_DIR}/Roboto-Thin.woff2) format('woff2'),
      url(${ROBOTO_DIR}/Roboto-Thin.woff) format('woff'), url(${ROBOTO_DIR}/Roboto-Thin.otf) format('opentype');
  }
  @font-face {
    font-family: 'Roboto';
    font-style: normal;
    font-weight: 300;
    src: local('Roboto Light'), local('Roboto-Light'), url(${ROBOTO_DIR}/Roboto-Light.woff2) format('woff2'),
      url(${ROBOTO_DIR}/Roboto-Light.woff) format('woff'), url(${ROBOTO_DIR}/Roboto-Light.otf) format('opentype');
  }
  @font-face {
    font-family: 'Roboto';
    font-style: normal;
    font-weight: 400;
    src: local('Roboto Regular'), local('Roboto-Regular'), url(${ROBOTO_DIR}/Roboto-Regular.woff2) format('woff2'),
      url(${ROBOTO_DIR}/Roboto-Regular.woff) format('woff'), url(${ROBOTO_DIR}/Roboto-Regular.otf) format('opentype');
  }
  @font-face {
    font-family: 'Roboto';
    font-style: normal;
    font-weight: 500;
    src: local('Roboto Medium'), local('Roboto-Medium'), url(${ROBOTO_DIR}/Roboto-Medium.woff2) format('woff2'),
      url(${ROBOTO_DIR}/Roboto-Medium.woff) format('woff'), url(${ROBOTO_DIR}/Roboto-Medium.otf) format('opentype');
  }
  @font-face {
    font-family: 'Roboto';
    font-style: normal;
    font-weight: 700;
    src: local('Roboto Bold'), local('Roboto-Bold'), url(${ROBOTO_DIR}/Roboto-Bold.woff2) format('woff2'),
      url(${ROBOTO_DIR}/Roboto-Bold.woff) format('woff'), url(${ROBOTO_DIR}/Roboto-Bold.otf) format('opentype');
  }
  @font-face {
    font-family: 'Roboto';
    font-style: normal;
    font-weight: 900;
    src: local('Roboto Black'), local('Roboto-Black'), url(${ROBOTO_DIR}/Roboto-Black.woff2) format('woff2'),
      url(${ROBOTO_DIR}/Roboto-Black.woff) format('woff'), url(${ROBOTO_DIR}/Roboto-Black.otf) format('opentype');
  }
  ...
  @font-face {
    ...
    src: url(${NOTOSANS_DIR}/NotoSans-Thin.woff2) format('woff2'),
      url(${NOTOSANS_DIR}/NotoSans-Thin.woff) format('woff'), url(${NOTOSANS_DIR}/NotoSans-Thin.otf) format('opentype'),
  ...
  @font-face {
    ...
    src: url(${NOTOSANS_DIR}/NotoSans-Bold.woff2) format('woff2'),
      url(${NOTOSANS_DIR}/NotoSans-Bold.woff) format('woff'), url(${NOTOSANS_DIR}/NotoSans-Bold.otf) format('opentype'),
